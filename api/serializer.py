...
class BaseSerializer(serializers.ModelSerializer):
    ...
    def process_required_fields(self, section: str):
        if self.required_fields and section in self.required_fields and len(self.required_fields.get(section)):
...
class InventorySerializer(BaseSerializer):
    ...
    def __init__(self, *args, **kwargs):
        if "required_fields" in kwargs and "supplier" in kwargs.get("required_fields") and len(kwargs.get("required_fields").get("supplier")):
    ...
    def get_supplier(self, instance):
        if not self.supplier_fields:
            ...
            return SupplierSerializer(instance=instance.supplier, required_fields=self.supplier_fields).data
